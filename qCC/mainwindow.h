...
public:
    ...
    **/
    ...
    ///
    void
    ADDRecently(QString str);

    ///
    /// \brief SetActivateRegisterPointPairTool
    ///
    void
    SetActivateRegisterPointPairTool();

    ///
    /// \brief SelectTWOPointCloud
    /// \return
    ///
    bool SelectTWOPointCloud();

    ///
    /// \brief SetActivateTranslateRotateMode
    ///
    void
    SetActivateTranslateRotateMode();

    ///
    /// \brief GetResultRegister
    /// \param finalTrans
    ///
    void
    GetResultRegister(ccGLMatrix finalTrans);
private slots:
    ///
    /// \brief on_actionColorChange_triggered
    ///
    void
    on_actionColorChange_triggered();

    ///
    /// \brief on_actionpath_triggered
    ///
    void
    on_actionpath_triggered();

    ///
    /// \brief on_actionobjtoosg_triggered
    ///
    void
    on_actionobjtoosg_triggered();

    ///
    /// \brief on_actionoptimization_triggered
    ///
    void
    on_actionoptimization_triggered();

    ///
    /// \brief on_actionSetLadirPer_triggered
    ///
    void
    on_actionSetLadirPer_triggered();

    ///
    /// \brief on_actionShow_triggered
    ///
    void
