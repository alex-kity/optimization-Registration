...
public:
    ...
    ///
    static void
    GetPointDataSelf1(std::vector<  lygs::trajectoryData> _vecs,
    ...
    ///
    static void
    GetPointDataSelf(std::vector<  lygs::trajectoryData> _vecs,
                     std::vector<std::pair<unsigned,unsigned>> &match);
    ...
    ///
    static void
    GetPointData(std::vector<  lygs::trajectoryData> _vecs,
                 std::vector<std::pair<unsigned,unsigned>> &match);
