...
///// \param parent
/////
//CSlamPointPairRegistrationDlg::CSlamPointPairRegistrationDlg(ccPickingHub* pickingHub, ccMainAppInterface* app, QWidget* parent/*=0*/)
...
//    connect(showAlignedCheckBox,	&QCheckBox::toggled,	this,	&CSlamPointPairRegistrationDlg::showAlignedEntities);
//    connect(showReferenceCheckBox,	&QCheckBox::toggled,	this,	&CSlamPointPairRegistrationDlg::showReferenceEntities);

//    connect(typeAlignToolButton,	&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::addManualAlignedPoint);
//    connect(typeRefToolButton,		&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::addManualRefPoint);

//    connect(unstackAlignToolButton,	&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::unstackAligned);
//    connect(unstackRefToolButton,	&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::unstackRef);

//    connect(alignToolButton,		&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::align);
//    connect(resetToolButton,		&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::reset);

//    connect(validToolButton,		&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::apply);
//    connect(cancelToolButton,		&QToolButton::clicked,	this,	&CSlamPointPairRegistrationDlg::cancel);

//    connect(adjustScaleCheckBox,	&QCheckBox::toggled,	this,	&CSlamPointPairRegistrationDlg::updateAlignInfo);
//    connect(TxCheckBox,				&QCheckBox::toggled,	this,	&CSlamPointPairRegistrationDlg::updateAlignInfo);
//    connect(TyCheckBox,				&QCheckBox::toggled,	this,	&CSlamPointPairRegistrationDlg::updateAlignInfo);
//    connect(TzCheckBox,				&QCheckBox::toggled,	this,	&CSlamPointPairRegistrationDlg::updateAlignInfo);
//    connect(rotComboBox, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),	this, &CSlamPointPairRegistrationDlg::updateAlignInfo);
...
/////
///// \brief CSlamPointPairRegistrationDlg::EntityContext::EntityContext
///// \param ent
/////
//CSlamPointPairRegistrationDlg::EntityContext::EntityContext(ccHObject* ent)
//    : entity(ent)
...
/////
///// \brief CSlamPointPairRegistrationDlg::EntityContext::restore
/////
//void CSlamPointPairRegistrationDlg::EntityContext::restore()
//{
//    if (entity)
//    {
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::EntityContexts::fill
///// \param entities
/////
//void CSlamPointPairRegistrationDlg::EntityContexts::fill(const ccHObject::Container& entities)
//{
//    clear();
//    isShifted = false;
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::clear
/////
//void CSlamPointPairRegistrationDlg::clear()
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::linkWith
///// \param win
///// \return
/////
//bool CSlamPointPairRegistrationDlg::linkWith(ccGLWindow* win)
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::start
///// \return
/////
//bool CSlamPointPairRegistrationDlg::start()
//{
//    assert(!m_alignedEntities.empty());
//    return ccOverlayDialog::start();
//}
/////
///// \brief CSlamPointPairRegistrationDlg::stop
///// \param state
/////
//void CSlamPointPairRegistrationDlg::stop(bool state)
//{
//    reset();
//    ccOverlayDialog::stop(state);
//}
/////
///// \brief SetEnabled_recursive
///// \param ent
/////
...
////}
/////
///// \brief CSlamPointPairRegistrationDlg::init
///// \param win
///// \param alignedEntities
///// \param referenceEntities
///// \return
/////
//bool CSlamPointPairRegistrationDlg::init(	ccGLWindow* win,
...
//void CSlamPointPairRegistrationDlg::addManualAlignedPoint()
//{
...
//void CSlamPointPairRegistrationDlg::addManualRefPoint()
//{
...
/////
///// \brief CSlamPointPairRegistrationDlg::pause
///// \param state
/////
//void CSlamPointPairRegistrationDlg::pause(bool state)
//{
//    m_paused = state;
//    setDisabled(state);
//}
...
/////
///// \brief CSlamPointPairRegistrationDlg::convertToSphereCenter
///// \param P
///// \param entity
///// \param sphereRadius
///// \return
/////
//bool CSlamPointPairRegistrationDlg::convertToSphereCenter(CCVector3d& P, ccHObject* entity, PointCoordinateType& sphereRadius)
//{
//    sphereRadius = 0;
//    if (	!entity
...
//            {
//                ccLog::Warning(QString("[CSlamPointPairRegistrationDlg] Detected sphere radius (%1) is too far from search radius!").arg(radius));
//            }
//            else
//            {
...
//                }
//                ccLog::Print(QString("[CSlamPointPairRegistrationDlg] Detected sphere radius = %1 (rms = %2)").arg(radius).arg(rms));
//                if (radius / searchRadius < 0.5 || radius / searchRadius > 2.0)
//                {
//                    ccLog::Warning("[CSlamPointPairRegistrationDlg] Sphere radius is too far from search radius!");
//                }
//                else if (rms / searchRadius >= maxRMSPercentage)
//                {
//                    ccLog::Warning("[CSlamPointPairRegistrationDlg] RMS is too high!");
//                }
//                else
//                {
//                    sphereRadius = radius;
...
//        else
//        {
//            ccLog::Warning("[CSlamPointPairRegistrationDlg] Failed to fit a sphere around the picked point!");
//        }
//    }
//    else
//    {
//        //not enough memory? No points inside the
//        ccLog::Warning("[CSlamPointPairRegistrationDlg] Failed to crop points around the picked point?!");
//    }
...
/////
///// \brief CSlamPointPairRegistrationDlg::onItemPicked
///// \param pi
/////
//void CSlamPointPairRegistrationDlg::onItemPicked(const PickedItem& pi)
//{
//    if (!m_associatedWin)
//        return;
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::onPointCountChanged
/////
//void CSlamPointPairRegistrationDlg::onPointCountChanged()
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::onDelButtonPushed
/////
//void CSlamPointPairRegistrationDlg::onDelButtonPushed()
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::addPointToTable
///// \param tableWidget
///// \param rowIndex
///// \param P
///// \param pointName
/////
//void CSlamPointPairRegistrationDlg::addPointToTable(	QTableWidget* tableWidget,
//                                                    int rowIndex,
//                                                    const CCVector3d& P,
//                                                    QString pointName )
//{
...
//        connect(delButton, &QToolButton::clicked, this, &CSlamPointPairRegistrationDlg::onDelButtonPushed);
//        tableWidget->setCellWidget(rowIndex, DEL_BUTTON_COL_INDEX, delButton);
//    }
//}
/////
///// \brief CSlamPointPairRegistrationDlg::addAlignedPoint
///// \param Pin
///// \param entity
///// \param shifted
///// \return
/////
//bool CSlamPointPairRegistrationDlg::addAlignedPoint(CCVector3d& Pin, ccHObject* entity/*=nullptr*/, bool shifted/*=false*/)
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::removeLabel
///// \param points
///// \param childIndex
///// \param entities
/////
//void CSlamPointPairRegistrationDlg::removeLabel(	ccPointCloud& points,
//                                                unsigned childIndex,
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::unstackAligned
/////
//void CSlamPointPairRegistrationDlg::unstackAligned()
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::removeAlignedPoint
///// \param index
///// \param autoRemoveDualPoint
/////
//void CSlamPointPairRegistrationDlg::removeAlignedPoint(int index, bool autoRemoveDualPoint/*=false*/)
//{
//    if (index >= static_cast<int>(m_alignedPoints.size()))
//    {
//        ccLog::Error("[CSlamPointPairRegistrationDlg::removeAlignedPoint] Invalid index!");
//        assert(false);
//        return;
//    }
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::addReferencePoint
///// \param Pin
///// \param entity
///// \param shifted
///// \return
/////
//bool CSlamPointPairRegistrationDlg::addReferencePoint(CCVector3d& Pin, ccHObject* entity/*=0*/, bool shifted/*=true*/)
//{
...
//}
/////
///// \brief CSlamPointPairRegistrationDlg::unstackRef
/////
//void CSlamPointPairRegistrationDlg::unstackRef()
//{
...
//void CSlamPointPairRegistrationDlg::removeRefPoint(int index, bool autoRemoveDualPoint/*=false*/)
//{
//    if (index >= static_cast<int>(m_refPoints.size()))
//    {
//        ccLog::Error("[CSlamPointPairRegistrationDlg::removeRefPoint] Invalid index!");
//        assert(false);
//        return;
//    }
...
//void CSlamPointPairRegistrationDlg::showAlignedEntities(bool state)
//{
...
//void CSlamPointPairRegistrationDlg::showReferenceEntities(bool state)
//{
...
//bool CSlamPointPairRegistrationDlg::callHornRegistration(CCCoreLib::PointProjectionTools::Transformation& trans, double& rms, bool autoUpdateTab)
//{
//    if (m_alignedEntities.empty())
//    {
//        assert(false);
...
//void CSlamPointPairRegistrationDlg::clearRMSColumns()
//{
...
//void CSlamPointPairRegistrationDlg::resetTitle()
//{
...
//void CSlamPointPairRegistrationDlg::updateAlignInfo()
//{
//    //reset title
//    resetTitle();
...
//void CSlamPointPairRegistrationDlg::align()
//{
//    CCCoreLib::PointProjectionTools::Transformation trans;
//    double rms;
...
//void CSlamPointPairRegistrationDlg::reset()
//{
//    if (m_alignedEntities.empty())
//        return;
...
//void CSlamPointPairRegistrationDlg::apply()
//{
//    CCCoreLib::PointProjectionTools::Transformation trans;
//    double rms = -1.0;
...
//        /////////////////////////////
//        m_transMatRT = transMat;
//        emit SignalRegistrationFinish();
...
//void CSlamPointPairRegistrationDlg::cancel()
//{
//    for (auto it = m_alignedEntities.begin(); it != m_alignedEntities.end(); ++it)
//        it.key()->enableGLTransformation(false);
