...
/// \param match
/// \param func
void ClidarCompute::GetPointDataSelf1(std::vector<  SensorTrajectoryData> _vecs,
...
/// \param match
///
void ClidarCompute::GetPointData(std::vector<  SensorTrajectoryData> _vecs, std::vector<std::pair<unsigned,unsigned>> &match)
{
