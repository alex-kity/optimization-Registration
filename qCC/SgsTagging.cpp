...
////SgsTagging::SgsTagging(ccPickingHub *pickingHub, QWidget *parent)
////{

////}

////SgsTagging::SgsTagging(QWidget *parent)
////{
...
////    connect(pickCenterToolButton,	&QCheckBox::toggled, this, &SgsTagging::pickPointAsCenter);
////    connect(upwardCheckBox,			&QCheckBox::toggled, this, &SgsTagging::onDipDirModified);
////    connect(dipDoubleSpinBox,		static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &SgsTagging::onDipDirChanged);
////    connect(dipDirDoubleSpinBox,	static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &SgsTagging::onDipDirChanged);
////    connect(nxDoubleSpinBox,		static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &SgsTagging::onNormalChanged);
////    connect(nyDoubleSpinBox,		static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &SgsTagging::onNormalChanged);
////    connect(nzDoubleSpinBox,		static_cast<void (QDoubleSpinBox::*)(double)>(&QDoubleSpinBox::valueChanged), this, &SgsTagging::onNormalChanged);

////    connect(buttonBox, &QDialogButtonBox::accepted, this, &SgsTagging::saveParamsAndAccept);
////    connect(buttonBox, &QDialogButtonBox::rejected, this, &SgsTagging::deleteLater);
...
////SgsTagging::~SgsTagging()
////{
////    assert(!pickCenterToolButton->isChecked());
////}

////void SgsTagging::saveParamsAndAccept()
////{
...
////void SgsTagging::onDipDirModified(bool)
////{
////    onDipDirChanged(0); //0 = fake argument
////}

////void SgsTagging::onDipDirChanged(double)
////{
...
////void SgsTagging::onNormalChanged(double)
////{
////    CCVector3 Nd;
...
////void SgsTagging::pickPointAsCenter(bool state)
////{
////    if (!m_pickingHub)
////    {
////        return;
...
////void SgsTagging::onItemPicked(const PickedItem& pi)
////{
////    if (!pi.entity)
////    {
////        return;
...
////void SgsTagging::initWithPlane(ccPlane* plane)
////{
...
////void SgsTagging::updatePlane(ccPlane* plane)
////{
////    if (!plane)
////    {
////        assert(false);
