    ...
    , m_pfDlg(nullptr)
{
    ...
    QFile qss( "E:/ai/source/build-point-cloud-annotation-tool-master-MSVC2017QT51364-Release/pointresource/Resources/qss/Darcula.qss");
...
void MainWindow::connectActions()
{
    ...
    //    //"hdmap" menu entry
    //    connect(m_UI->actionobjtoosg,	&QAction::triggered, this, [this] () {
    //        ManagerWidget* _ManagerWidget = new ManagerWidget(this);
    //        _ManagerWidget->show();
    //    });
...
void MainWindow::on_actionpath_triggered()
{
    ...
    ccGLMatrix transMat;
    transMat.setTranslation(CCVector3f(10.0f, 10.0f, 10.0f));
...
void MainWindow::on_actionobjtoosg_triggered()
{
    ManagerWidget* _ManagerWidget = new ManagerWidget(this);
    _ManagerWidget->show();
}
...
void MainWindow::on_actionoptimization_triggered()
{
    ...
    if (!haveOneSelection())
    {
        ccConsole::Error(QStringLiteral("请在 DB Tree 内选择mesh实体对象!"));
        return;
    }
    ...
    {
        ccConsole::Error(QStringLiteral("选择的对象不是mesh类型！"));
        return;
    }
