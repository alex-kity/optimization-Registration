...
public:
    ...
    {
        ComputeOctreeDialog->setWindowTitle(QApplication::translate("ComputeOctreeDialog", "Compute Octree", 0));
        headerLabel->setText(QApplication::translate("ComputeOctreeDialog", "Max subdivision level: ??", 0));
        groupBox->setTitle(QApplication::translate("ComputeOctreeDialog", "Octree box", 0));
        defaultRadioButton->setText(QApplication::translate("ComputeOctreeDialog", "Default", 0));
        cellSizeRadioButton->setText(QApplication::translate("ComputeOctreeDialog", "Cell size at max level", 0));
        customBBRadioButton->setText(QApplication::translate("ComputeOctreeDialog", "Custom bounding box", 0));
        customBBToolButton->setText(QApplication::translate("ComputeOctreeDialog", "Edit", 0));
    } // retranslateUi
