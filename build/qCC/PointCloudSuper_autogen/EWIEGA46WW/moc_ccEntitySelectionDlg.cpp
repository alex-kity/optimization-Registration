...
const QMetaObject ccEntitySelectionDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccEntitySelectionDialog.data,
      qt_meta_data_ccEntitySelectionDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ccEntitySelectionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ccEntitySelectionDialog.stringdata0))
        return static_cast<void*>(const_cast< ccEntitySelectionDialog*>(this));
