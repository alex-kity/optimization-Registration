...
const QMetaObject ccComputeOctreeDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ccComputeOctreeDlg.data,
      qt_meta_data_ccComputeOctreeDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ccComputeOctreeDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ccComputeOctreeDlg.stringdata0))
        return static_cast<void*>(const_cast< ccComputeOctreeDlg*>(this));
    if (!strcmp(_clname, "Ui::ComputeOctreeDialog"))
        return static_cast< Ui::ComputeOctreeDialog*>(const_cast< ccComputeOctreeDlg*>(this));
