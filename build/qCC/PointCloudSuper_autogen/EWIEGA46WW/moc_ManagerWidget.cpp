...
const QMetaObject ManagerWidget::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ManagerWidget.data,
      qt_meta_data_ManagerWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ManagerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ManagerWidget.stringdata0))
        return static_cast<void*>(const_cast< ManagerWidget*>(this));
