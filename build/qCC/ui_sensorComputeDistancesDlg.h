...
public:
    ...
    {
        sensorComputeDistancesDlg->setWindowTitle(QApplication::translate("sensorComputeDistancesDlg", "Sensor range computation", 0));
        checkSquaredDistance->setText(QApplication::translate("sensorComputeDistancesDlg", "Squared distances", 0));
    } // retranslateUi
