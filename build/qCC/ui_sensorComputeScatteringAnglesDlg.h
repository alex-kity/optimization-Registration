...
public:
    ...
    {
        sensorComputeScatteringAnglesDlg->setWindowTitle(QApplication::translate("sensorComputeScatteringAnglesDlg", "Compute scattering angles", 0));
        anglesToDegCheckbox->setText(QApplication::translate("sensorComputeScatteringAnglesDlg", "Convert angles to degree", 0));
    } // retranslateUi
