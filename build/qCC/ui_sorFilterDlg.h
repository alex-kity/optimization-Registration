...
public:
    ...
    {
        SorFilterDialog->setWindowTitle(QApplication::translate("SorFilterDialog", "Statistical Outlier Removal", 0));
        label->setText(QApplication::translate("SorFilterDialog", "Number of points to use for\n"
"mean distance estimation", 0));
#ifndef QT_NO_TOOLTIP
        knnSpinBox->setToolTip(QApplication::translate("SorFilterDialog", "Number of neighbors (used to compute the average distance of each point to its neighbors)", 0));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("SorFilterDialog", "Standard deviation\n"
"multiplier threshold (nSigma)", 0));
        label_2->setText(QApplication::translate("SorFilterDialog", "(max distance = average distance + nSigma * std. dev.)", 0));
    } // retranslateUi
