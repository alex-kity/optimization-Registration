...
public:
    ...
    void setupUi(QDialog *BoundingBoxEditorDialog)
    {
        ...
        xLabel->setText(QStringLiteral("X"));
        ...
        yLabel->setText(QStringLiteral("Y"));
        ...
        zLabel->setText(QStringLiteral("Z"));
        ...
        oriZCheckBox->setText(QStringLiteral("Z"));
        ...
        oriYCheckBox->setText(QStringLiteral("Y"));
        ...
        oriXCheckBox->setText(QStringLiteral("X"));
        ...
        fromClipboardPushButton->setObjectName(QStringLiteral("fromClipboardPushButton"));

        gridLayout_2->addWidget(fromClipboardPushButton, 2, 0, 1, 1);

        toClipboardPushButton = new QPushButton(oriGroupBox);
        toClipboardPushButton->setObjectName(QStringLiteral("toClipboardPushButton"));
...
#endif // QT_NO_TOOLTIP
        fromClipboardPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "From clipboard", 0));
        toClipboardPushButton->setText(QApplication::translate("BoundingBoxEditorDialog", "To clipboard", 0));
