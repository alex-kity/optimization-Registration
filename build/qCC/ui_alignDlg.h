...
public:
    ...
    {
        AlignDialog->setWindowTitle(QApplication::translate("AlignDialog", "Clouds alignment", 0));
        groupBox_5->setTitle(QApplication::translate("AlignDialog", "Model and data", 0));
        label_10->setText(QApplication::translate("AlignDialog", "Data:", 0));
#ifndef QT_NO_TOOLTIP
        dataCloud->setToolTip(QApplication::translate("AlignDialog", "the data cloud is the entity to align with the model cloud: it will be displaced (green cloud)", 0));
#endif // QT_NO_TOOLTIP
        label_9->setText(QApplication::translate("AlignDialog", "Model:", 0));
#ifndef QT_NO_TOOLTIP
        modelCloud->setToolTip(QApplication::translate("AlignDialog", "the model cloud is the reference: it won't move (red cloud)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        swapButton->setToolTip(QApplication::translate("AlignDialog", "press once to exchange model and data clouds", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        swapButton->setStatusTip(QApplication::translate("AlignDialog", "press once to exchange model and data clouds", 0));
#endif // QT_NO_STATUSTIP
        swapButton->setText(QApplication::translate("AlignDialog", "swap", 0));
        groupBox->setTitle(QApplication::translate("AlignDialog", "Alignment parameters", 0));
        label->setText(QApplication::translate("AlignDialog", "Number of trials:", 0));
#ifndef QT_NO_TOOLTIP
        nbTries->setToolTip(QApplication::translate("AlignDialog", "Number of 4 points bases tested to find the best rigid transform. Great values may lead to long computation time.", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("AlignDialog", "Overlap:", 0));
#ifndef QT_NO_TOOLTIP
        overlap->setToolTip(QApplication::translate("AlignDialog", "Rough estimation of the two clouds overlap rate (between 0 and 1)", 0));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("AlignDialog", "Delta:", 0));
#ifndef QT_NO_TOOLTIP
        delta->setToolTip(QApplication::translate("AlignDialog", "Estimation of the distance wished between the two clouds after registration.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        deltaEstimation->setToolTip(QApplication::translate("AlignDialog", "The computer will estimate the best delta parameter", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        deltaEstimation->setStatusTip(QApplication::translate("AlignDialog", "The computer will estimate the best delta parameter", 0));
#endif // QT_NO_STATUSTIP
        deltaEstimation->setText(QApplication::translate("AlignDialog", "Estimate", 0));
#ifndef QT_NO_TOOLTIP
        isNbCandLimited->setToolTip(QApplication::translate("AlignDialog", "For each attempt (see above parameter), candidate bases are found. If there are too much candidates, the program may take a long time to finish. Check this box to bound the number of candidates.", 0));
#endif // QT_NO_TOOLTIP
        isNbCandLimited->setText(QApplication::translate("AlignDialog", "Limit max. number of candidates", 0));
#ifndef QT_NO_TOOLTIP
        nbMaxCandidates->setToolTip(QApplication::translate("AlignDialog", "Maximal number of candidates allowed (check the left box to use this parameter)", 0));
#endif // QT_NO_TOOLTIP
        groupBox_2->setTitle(QApplication::translate("AlignDialog", "Sampling", 0));
        label_4->setText(QApplication::translate("AlignDialog", "Method:", 0));
        groupBox_3->setTitle(QApplication::translate("AlignDialog", "Data", 0));
        label_7->setText(QApplication::translate("AlignDialog", "None", 0));
        label_8->setText(QApplication::translate("AlignDialog", "All", 0));
#ifndef QT_NO_TOOLTIP
        dataSample->setToolTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the data cloud.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        dataSample->setStatusTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the data cloud.", 0));
#endif // QT_NO_STATUSTIP
        dataRemaining->setText(QApplication::translate("AlignDialog", "remaining points", 0));
        groupBox_4->setTitle(QApplication::translate("AlignDialog", "Model", 0));
        label_6->setText(QApplication::translate("AlignDialog", "None", 0));
        label_5->setText(QApplication::translate("AlignDialog", "All", 0));
#ifndef QT_NO_TOOLTIP
        modelSample->setToolTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the model cloud.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_STATUSTIP
        modelSample->setStatusTip(QApplication::translate("AlignDialog", "Move to the left (none) to decrease the number of points  to keep in the model cloud.", 0));
#endif // QT_NO_STATUSTIP
        modelRemaining->setText(QApplication::translate("AlignDialog", "remaining points", 0));
    } // retranslateUi
