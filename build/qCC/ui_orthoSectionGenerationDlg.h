...
public:
    ...
    {
        OrthoSectionGenerationDlg->setWindowTitle(QApplication::translate("OrthoSectionGenerationDlg", "Orthogonal sections generation", 0));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("OrthoSectionGenerationDlg", "Selected path length", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OrthoSectionGenerationDlg", "path length", 0));
        label_4->setText(QApplication::translate("OrthoSectionGenerationDlg", "sections", 0));
#ifndef QT_NO_TOOLTIP
        sectionCountLineEdit->setToolTip(QApplication::translate("OrthoSectionGenerationDlg", "Number of sections that will be generated (depends on the 'step' parameter)", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OrthoSectionGenerationDlg", "step", 0));
#ifndef QT_NO_TOOLTIP
        stepDoubleSpinBox->setToolTip(QApplication::translate("OrthoSectionGenerationDlg", "Section generation step", 0));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("OrthoSectionGenerationDlg", "width", 0));
#ifndef QT_NO_TOOLTIP
        widthDoubleSpinBox->setToolTip(QApplication::translate("OrthoSectionGenerationDlg", "Total width of each orthogonal section (centered on the path line)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        autoSaveAndRemoveCheckBox->setToolTip(QApplication::translate("OrthoSectionGenerationDlg", "Automatically save then remove the generatrix polyline", 0));
#endif // QT_NO_TOOLTIP
        autoSaveAndRemoveCheckBox->setText(QApplication::translate("OrthoSectionGenerationDlg", "auto save and remove generatrix", 0));
    } // retranslateUi
