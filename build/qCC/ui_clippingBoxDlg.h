...
public:
    ...
    void setupUi(QDialog *ClippingBoxDlg)
    {
        ...
        label_2->setText(QStringLiteral("X"));
        ...
        label_4->setText(QStringLiteral("Z"));
        ...
        minusXShiftToolButton->setText(QStringLiteral("-X"));
        ...
        plusXShiftToolButton->setText(QStringLiteral("+X"));
        ...
        minusYShiftToolButton->setText(QStringLiteral("-Y"));
        ...
        plusYShiftToolButton->setText(QStringLiteral("+Y"));
        ...
        minusZShiftToolButton->setText(QStringLiteral("-Z"));
        ...
        plusZShiftToolButton->setText(QStringLiteral("+Z"));
