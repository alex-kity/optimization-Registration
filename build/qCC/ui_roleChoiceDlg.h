...
public:
    ...
    {
        RoleChoiceDialog->setWindowTitle(QApplication::translate("RoleChoiceDialog", "Choose role", 0));
        firstlabel->setText(QApplication::translate("RoleChoiceDialog", "Compared", 0));
        secondlabel->setText(QApplication::translate("RoleChoiceDialog", "Reference", 0));
        swapButton->setText(QApplication::translate("RoleChoiceDialog", "Swap", 0));
    } // retranslateUi
