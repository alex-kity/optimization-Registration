...
public:
    ...
    {
        LabelingDialog->setWindowTitle(QApplication::translate("LabelingDialog", "Connected Components", 0));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("LabelingDialog", "Grid subdivision level: the greater, the finest", 0));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("LabelingDialog", "Octree Level", 0));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("LabelingDialog", "Minimum number of points per component", 0));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("LabelingDialog", "Min. points per component", 0));
        randomColorsCheckBox->setText(QApplication::translate("LabelingDialog", "random colors (warning: overwrites existing ones)", 0));
    } // retranslateUi
