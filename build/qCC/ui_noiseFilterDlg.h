...
public:
    ...
    {
        NoiseFilterDialog->setWindowTitle(QApplication::translate("NoiseFilterDialog", "Filter noise", 0));
        groupBox->setTitle(QApplication::translate("NoiseFilterDialog", "Neighbors", 0));
        knnRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Points (kNN)", 0));
        radiusRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Radius (Sphere)", 0));
        groupBox_2->setTitle(QApplication::translate("NoiseFilterDialog", "Max error", 0));
        relativeRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Relative", 0));
        absErrorRadioButton->setText(QApplication::translate("NoiseFilterDialog", "Absolute", 0));
        removeIsolatedPointsCheckBox->setText(QApplication::translate("NoiseFilterDialog", "Remove isolated points", 0));
    } // retranslateUi
