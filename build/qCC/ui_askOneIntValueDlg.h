...
public:
    ...
    {
        AskOneIntValueDialog->setWindowTitle(QApplication::translate("AskOneIntValueDialog", "Set Value", 0));
        valueLabel->setText(QApplication::translate("AskOneIntValueDialog", "Value", 0));
    } // retranslateUi
