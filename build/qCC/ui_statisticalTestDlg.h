...
public:
    ...
    {
        StatisticalTestDialog->setWindowTitle(QApplication::translate("StatisticalTestDialog", "Dialog", 0));
        groupBox->setTitle(QApplication::translate("StatisticalTestDialog", "Noise model", 0));
        param1Label->setText(QApplication::translate("StatisticalTestDialog", "param1", 0));
        param2Label->setText(QApplication::translate("StatisticalTestDialog", "param2", 0));
        param3Label->setText(QApplication::translate("StatisticalTestDialog", "param3", 0));
#ifndef QT_NO_STATUSTIP
        label->setStatusTip(QApplication::translate("StatisticalTestDialog", "false rejection probability", 0));
#endif // QT_NO_STATUSTIP
        label->setText(QApplication::translate("StatisticalTestDialog", "p(Chi2)", 0));
#ifndef QT_NO_STATUSTIP
        nLabel->setStatusTip(QApplication::translate("StatisticalTestDialog", "neighbors used to compute observed local dist.", 0));
#endif // QT_NO_STATUSTIP
        nLabel->setText(QApplication::translate("StatisticalTestDialog", "Neighbors", 0));
    } // retranslateUi
