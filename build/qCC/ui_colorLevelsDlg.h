...
public:
    ...
    {
        ColorLevelsDialog->setWindowTitle(QApplication::translate("ColorLevelsDialog", "Change Color Levels", 0));
        label->setText(QApplication::translate("ColorLevelsDialog", "Channel(s)", 0));
        channelComboBox->clear();
        channelComboBox->insertItems(0, QStringList()
         << QApplication::translate("ColorLevelsDialog", "RGB", 0)
         << QApplication::translate("ColorLevelsDialog", "Red", 0)
         << QApplication::translate("ColorLevelsDialog", "Green", 0)
         << QApplication::translate("ColorLevelsDialog", "Blue", 0)
        );
        label_2->setText(QApplication::translate("ColorLevelsDialog", "Input levels", 0));
        outputLevelsCheckBox->setText(QApplication::translate("ColorLevelsDialog", "Output levels", 0));
    } // retranslateUi
