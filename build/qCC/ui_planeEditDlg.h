...
public:
    ...
    void retranslateUi(QDialog *PlaneEditDlg)
    {
        ...
        upwardCheckBox->setToolTip(QApplication::translate("PlaneEditDlg", "Whether the plane normal should point upward (Z+) or downward (Z-)", 0));
#endif // QT_NO_TOOLTIP
        upwardCheckBox->setText(QApplication::translate("PlaneEditDlg", "upward", 0));
        orientationTabWidget->setTabText(orientationTabWidget->indexOf(dipTab), QApplication::translate("PlaneEditDlg", "Dip / dip direction", 0));
        orientationTabWidget->setTabText(orientationTabWidget->indexOf(normTab), QApplication::translate("PlaneEditDlg", "Normal", 0));
        dimGroupBox->setTitle(QApplication::translate("PlaneEditDlg", "Dimensions", 0));
...
#endif // QT_NO_TOOLTIP
        centerGroupBox->setTitle(QApplication::translate("PlaneEditDlg", "Center", 0));
#ifndef QT_NO_TOOLTIP
