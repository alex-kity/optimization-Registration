...
""));
        ...
        actionHelpShortcuts->setObjectName(QStringLiteral("actionHelpShortcuts"));
...
""));
    ...
    void retranslateUi(QMainWindow *ccViewerClass)
    {
        ...
        actionHelpShortcuts->setText(QApplication::translate("ccViewerClass", "Shortcuts", 0));
        actionHelpShortcuts->setShortcut(QApplication::translate("ccViewerClass", "F1", 0));
