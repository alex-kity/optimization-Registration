...
public:
    ...
    {
        MLSDialog->setWindowTitle(QApplication::translate("MLSDialog", "Moving Least Squares Smoothing and Reconstruction", 0));
        search_radius_label->setText(QApplication::translate("MLSDialog", "Search Radius", 0));
        compute_normals->setText(QApplication::translate("MLSDialog", "Compute Normals", 0));
        use_polynomial->setText(QApplication::translate("MLSDialog", "Use Polynomial \n"
"(instead of tangent)", 0));
        polynomial_order_label->setText(QApplication::translate("MLSDialog", "Polynomial Order", 0));
        squared_gaussian_parameter_label->setText(QApplication::translate("MLSDialog", "Squared Gaussian \n"
"Parameter", 0));
        upsampling_method_label->setText(QApplication::translate("MLSDialog", "Upsampling Method", 0));
        sample_local_plane_method->setTitle(QApplication::translate("MLSDialog", "Sample Local Plane", 0));
        upsampling_radius_label->setText(QApplication::translate("MLSDialog", "Upsampling Radius", 0));
        upsampling_step_size_label->setText(QApplication::translate("MLSDialog", "Upsampling Step Size", 0));
        random_uniform_density_method->setTitle(QApplication::translate("MLSDialog", "Random Uniform Density", 0));
        step_point_density_label->setText(QApplication::translate("MLSDialog", "Step Point Density", 0));
        voxel_grid_dilation_method->setTitle(QApplication::translate("MLSDialog", "Voxel Grid Dilation", 0));
        dilation_voxel_grid_label->setText(QApplication::translate("MLSDialog", "Dilation Voxel Size", 0));
        dilation_iterations_label->setText(QApplication::translate("MLSDialog", "Dilation Iterations", 0));
    } // retranslateUi
