...
public:
    ...
    {
        StatisticalOutliersRemoverDlg->setWindowTitle(QApplication::translate("StatisticalOutliersRemoverDlg", "Statistical Outliers Removal", 0));
...
" multiplier threshold (nSigma)", 0));
        label_3->setText(QApplication::translate("StatisticalOutliersRemoverDlg", "(max distance = average distance + nSigma * std. dev.)", 0));
    } // retranslateUi
