...
public:
    ...
    {
        SIFTExtractDlg->setWindowTitle(QApplication::translate("SIFTExtractDlg", "SIFT Extraction", 0));
        label_4->setText(QApplication::translate("SIFTExtractDlg", "Intensity Field", 0));
        label_3->setText(QApplication::translate("SIFTExtractDlg", "Scales per Octave", 0));
        label->setText(QApplication::translate("SIFTExtractDlg", "Minimum Scale", 0));
        label_2->setText(QApplication::translate("SIFTExtractDlg", "Number of Octaves", 0));
        useMinContrast->setText(QApplication::translate("SIFTExtractDlg", "Minimum Contrast", 0));
    } // retranslateUi
