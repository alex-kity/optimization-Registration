...
public:
    ...
    {
        NormalEstimationDialog->setWindowTitle(QApplication::translate("NormalEstimationDialog", "Neighborhood Search Radius", 0));
        label->setText(QApplication::translate("NormalEstimationDialog", "Search Radius", 0));
        useKnnCheckBox->setText(QApplication::translate("NormalEstimationDialog", "Use Knn Search", 0));
        curvatureCheckBox->setText(QApplication::translate("NormalEstimationDialog", "Overwrite Curvature", 0));
        searchSurfaceCheckBox->setText(QApplication::translate("NormalEstimationDialog", "Search Surface", 0));
    } // retranslateUi
