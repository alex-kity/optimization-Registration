...
public:
    ...
    void setupUi(QDialog *DisplayOptionsDlg)
    {
        ...
        pageColorAndMatOptions->setGeometry(QRect(0, 0, 496, 411));
        ...
        pageSFOptions->setGeometry(QRect(0, 0, 496, 411));
        ...
        pageLabelsOptions->setGeometry(QRect(0, 0, 496, 411));
        ...
        pageOtherOptions->setGeometry(QRect(0, 0, 496, 411));
        ...
        singleClickPickingCheckBox->setObjectName(QStringLiteral("singleClickPickingCheckBox"));
        singleClickPickingCheckBox->setChecked(true);

        verticalLayout_8->addWidget(singleClickPickingCheckBox);
    ...
    void retranslateUi(QDialog *DisplayOptionsDlg)
    {
        ...
        singleClickPickingCheckBox->setText(QApplication::translate("DisplayOptionsDlg", "Single Click Object Picking (Can be slow on large point clouds)", 0));
